<?php
namespace Tecnodesignc\Stylist;

use Cache;
use Config;
use Tecnodesignc\Stylist\Html\ThemeHtmlBuilder;
...
class StylistServiceProvider extends AggregateServiceProvider
{
    ...
    private function registerAliases()
    {
        ...
        $aliasLoader->alias('Stylist', 'Tecnodesignc\Stylist\Facades\StylistFacade');
        $aliasLoader->alias('Theme', 'Tecnodesignc\Stylist\Facades\ThemeFacade');

        $this->app->alias('stylist', 'Tecnodesignc\Stylist\Theme\Stylist');
    }
    ...
    {
        $this->commands(
            'Tecnodesignc\Stylist\Console\PublishAssetsCommand'
        );
    }
